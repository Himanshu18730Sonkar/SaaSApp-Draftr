  ...
  return (
    <div className="bg-slate-50 overflow-hidden">
      <div className="flex max-md:flex-col items-center gap-10 md:gap-20 max-w-350 mx-auto px-6 py-20">
        <div className="bg-[#e1e3e7] sm:pl-22 sm:pt-12 p-6 md:w-4xl w-full rounded-4xl overflow-hidden sm:h-120 h-fit ">
          <img
            src={ScreenImg}
            alt="screen"
        ...
        >
          <div className="space-y-5">
            ...
            <p className="sm:text-lg text-md font-semibold leading-relaxed text-slate-600">
              Discover how our design platform meets your needs, whether you're
              a freelancer, startup, or enterprise.
            </p>
          </div>
